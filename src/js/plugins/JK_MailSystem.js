...
Window_Mail.prototype.isPageChangeEnabled = function() {
    return this.isOpenAndActive() && this.maxPages() >= 2;
};
...
Window_Mail.prototype.resetPage = function(){
  this._pageIndex = 0;
  this.makeItemList();
  this.refresh();
};
