...
var Felski = Felski || {};  
Felski.AUTOSAVE = {};
Felski.AUTOSAVE.version = 1.00;

/*:
* @plugindesc v1.0.0 This plugin enables autosaving in your game. For RPG Maker MV 1.6.1.
* @author Felski
* @help 
...
Felski.AUTOSAVE.onMapChange = String(parameters['Save After Map Change'] || 'false');
...
Felski.AUTOSAVE.onMenuExit = String(parameters['Save On Menu Exit'] || 'false');
